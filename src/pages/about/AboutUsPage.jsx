...
const values = ["Skill Development", "Communication", "Community", "Excellence", "Innovation", "Growth Mindset"]
        ...
        <div className='w-screen h-auto xl:h-screen p-8'>
          ...
          <div className='flex flex-col space-y-4 mx-auto w-[70%] lg:flex-row items-center justify-evenly my-[1rem] xl:mt-[6rem]'>
            <div className="flex flex-col lg:flex-row justify-between border bg-white shadow-md rounded-[1rem] max-h-[30rem]">
                ...
                <img className="w-full lg:w-1/2 xs:hidden md:visible lg:visible" src={images.Schedule}  alt="schedule" />
            </div>
          </div>
        </div>

        <div className=' xl:w-screen h-[40vh] xl:h-[70vh] bg-[#025750] relative w-full xl:mx-0 mb-[150vh] lg:mb-[120vh] md:mb-[120vh] mt-[20%] flex items-center justify-center'>
