      ...
      <div className='bg-[#F6F6F6]'>
        <div className='w-screen h-auto xl:h-screen p-8'>
          ...
          <div className='flex flex-col space-y-4 mx-auto lg:w-[70%] md:w-[70%] w-[90%] lg:flex-row items-center justify-evenly my-[1rem] xl:mt-[6rem]'>
            <div className="flex flex-col lg:flex-row justify-between border md:my-5 bg-white shadow-md rounded-[1rem] max-h-[30rem]">
                ...
                <img className="w-full lg:w-1/2 lg:block md:block hidden lg:h-[29.5rem] md:h-[40rem]" src={images.Schedule}  alt="schedule" />
            </div>
          </div>
        </div>
