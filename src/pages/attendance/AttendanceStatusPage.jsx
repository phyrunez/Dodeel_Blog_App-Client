  ...
  return (
    <MainLayout>
        <section className='bg-[#F6F6F6]'>
            <h1 className='xl:leading-[63.96px] lg:leading-[63.96px] md:leading-[60px] leading-[20px] xl:text-[48px] lg:text-[48px] md:text-[35px] text-[38px] font-bold text-center lg:mb-[4rem] md:mb-[4rem] mb-[4.5rem] mt-[4rem]'>Check Attendance Status</h1>
            ...
            <div className='flex flex-col space-y-4 mx-auto w-[70%] lg:flex-row md:mb-10 items-center justify-evenly my-[1rem] xl:mt-[6rem]'>
                <div className="flex flex-col lg:flex-row justify-around max-h-[30rem] lg:mb-4 md:mb-[10rem] mb-20">
                    ...
                    <div className="w-full lg:justify-start px-2 lg:px-[50px]">
                        <div className="flex flex-col py-2 lg:py-[20px]">
                            <div className=''>
                                ...
                                <p className='font font-poppins'>
                                    ...
                                    It more exciting that as a member of the CDS you can lookup and track your attendance Status 
                                    just by using the link below and seamlessly filling out your details
                                </div>
                            </div>
                        </div>
                        ...
                        >
                            <Link to="https://script.google.com/macros/s/AKfycbwJEuGh3mwDVDtMybxg8izBXN7vLHyqPCoqOTboUr4bzFEkPIJ55Qhs6T3YWvb4dlTKdA/exec">
                                Visit Site
                            </Link>
                        </button>
                        
                    </div>
                    <img className="w-full lg:w-1/2 xs:hidden md:visible lg:visible" src={images.Attendance}  alt="schedule" />
                </div>
            </div>
        </section>
    </MainLayout>
