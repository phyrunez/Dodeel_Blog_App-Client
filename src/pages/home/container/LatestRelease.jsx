...
const LatestRelease = () => {
  return (
    <div className="container mx-auto my-10 w-[77%]">
        <h1 className="text-[#333333] text-3xl py-5 font-bold">Latest Release</h1>
        <div className="flex justify-between border bg-white shadow-md rounded-[1rem]">
            <img height="10rem" width="600rem" src={images.LatestReleaseImage} alt="latest-release" />
            <div className="w-full lg:justify-start px-[50px]">
